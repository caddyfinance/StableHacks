...
export class OperationsService {
  getSystemStatus() {
    return [
      { service: 'L2 DB Layer', status: 'healthy', latency: '8ms', lastCheck: new Date().toISOString() },
      ...
      { service: 'Solstice Strategy', status: 'healthy', latency: '198ms', lastCheck: new Date().toISOString() },
    ];
  }
