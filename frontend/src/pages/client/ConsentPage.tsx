  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card title="Pending Requests" subtitle="Actions awaiting your approval">
        {loading ? (
          <p className="text-xs text-vault-muted animate-pulse">Loading consent requests...</p>
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {pendingRequests.map((req) => (
                  <tr
                    key={req.requestId}
                    className="border-b border-vault-border/50 hover:bg-white/[0.02]"
                  >
                    ...
                    <td className="py-2.5 pr-3 text-white text-right font-mono">
                    ...
                    <td className="py-2.5 pr-3 text-vault-muted">
                    ...
                    <td className="py-2.5 text-right">
                      <button
                        ...
                        className="px-4 py-1.5 text-[10px] font-semibold rounded bg-green-600 hover:bg-green-500 text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                      >
      ...
      <Card title="Recently Approved" subtitle="Consent requests that have been approved">
        {loading ? (
          ...
          <p className="text-xs text-vault-muted">No recently approved requests.</p>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead>
