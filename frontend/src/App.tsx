...
const roleAccess: Record<Role, string[]> = {
  admin: ['/amina', '/amina/credentials', '/amina/vault-factory', '/amina/mandate', '/amina/funding', '/amina/providers', '/amina/wallet-controllers', '/amina/transfer-checks', '/amina/compliance', '/amina/audit-log', '/amina/transparency', '/amina/operations', '/amina/architecture', '/amina/translation-pipeline', '/amina/finstar-ledger'],
  portfolio_manager: ['/amina', '/amina/mandate', '/amina/funding', '/amina/execution', '/amina/providers', '/amina/transfer-checks', '/amina/compliance', '/amina/architecture', '/amina/translation-pipeline', '/amina/finstar-ledger'],
  compliance_officer: ['/amina', '/amina/providers', '/amina/wallet-controllers', '/amina/transfer-checks', '/amina/compliance', '/amina/audit-log', '/amina/transparency', '/amina/architecture', '/amina/translation-pipeline', '/amina/finstar-ledger'],
  emergency_admin: ['/amina', '/amina/emergency', '/amina/operations', '/amina/compliance', '/amina/architecture'],
